...
const navLinks = [
  ...
  { label: "FAQ", href: "#faq" },
  { label: "Discord", href: "https://discord.gg/avenya" },
  { label: "Boutique", href: "https://avenyarp.tebex.io/" },
  { label: "Règlement", href: "https://astrafr.gitbook.io/reglement/" },
  { label: "TikTok", href: "https://www.tiktok.com/@avenyaroleplay?is_from_webapp=1&sender_device=pc" },
];
